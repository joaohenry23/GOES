...
def create_gridmap(Domain, PixResol=2.0, fmt=np.float32):
    ...
    dict_LonsCor = {'long_name':'Longitude of corner of pixels', 'standard_name':'pixels corner longitude',
                    'units':'degrees_east', 'undef':-999.99, 'axis':'YX', 'dimensions':('y','x'), 'data':None}
    dict_LatsCor = {'long_name':'Latitude of corner of pixels', 'standard_name':'pixels corner latitude',
...
def accumulate_in_gribmap(lightning_lon, lightning_lat, Lons, Lats, dx=200, dy=200, dz=200, show_progress=True, fmt=np.int32):
